...
/**
 * Class EnablerService defines service for managing  RSVP list enabled for nodes
...
class EnablerService
{
  ...
  /**
   * Set an individual node to be RSVP enabled
   *
  ...
  /**
   * Delete enabled settings for an individual node
   *
   * @param \Drupal\node\Entity\Node $node
   */
