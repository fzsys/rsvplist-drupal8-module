...
/**
 * Class RSVPSettingsForm defines a form to configure RSVP list module settings
...
class RSVPSettingsForm extends ConfigFormBase
{
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    $form['rsvplist_types'] = [
      ...
      '#options' => $types,
      '#description' => $this->t('On the specified node types, an RSVP option will be available
